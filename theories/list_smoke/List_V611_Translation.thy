theory List_V611_Translation
  imports "AutoCorres2_Main.AutoCorres_Main"
begin

text \<open>
  Source-only translation smoke for the unmodified FreeRTOS V6.1.1 list.c.
  The configuration and port macros are audited in PROOF_PORT_LEDGER.md.
\<close>
...
autocorres [
  addressable_fields = xLIST.xListEnd,
  no_body =
